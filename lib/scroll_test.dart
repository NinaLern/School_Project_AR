...
import 'scroll_detail1.dart';
import 'scroll_detail2.dart';
import 'scroll_detail3.dart';
                          ...
                          children: <Widget>[
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: const BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: AssetImage(
                                              'assets/images/Exhibition1.jpeg'),
                                          fit: BoxFit.cover,
                                        ),
                                        boxShadow: [
                                          BoxShadow(
                            ...
                            Card(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  Navigator.of(context).push(_createDetail3());
                                },
                              ),
                            ),
                          ],
...
Route _createDetail3() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) =>
        const ExhitbitionDetailPage3(),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(1, 0);
      const end = Offset.zero;
      const curve = Curves.ease;
